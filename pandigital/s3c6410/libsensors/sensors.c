...
/*        { "BMA150 3-axis Accelerometer",
        ...
        { "terminander Accelerometer",
                "Bosh",
                1, SENSORS_HANDLE_BASE+ID_A,
               // SENSOR_TYPE_ACCELEROMETER, 10240.0f, 1.0f, 0.2f, 0, { } },
                SENSOR_TYPE_ACCELEROMETER, 2.0f, 0.0012210013f, 0.2f, 0, { } },
...
static struct hw_module_methods_t sensors_module_methods = {
	/* terminander */
	/*LOGE("trm, sensors_module_methods"); */   
    .open = open_sensors
};

const struct sensors_module_t HAL_MODULE_INFO_SYM = {
	/* terminander */
	/*LOGE("trm, HAL_MODULE_INFO_SYM");*/    
    .common = {
